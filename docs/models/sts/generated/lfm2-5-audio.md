...
Multimodal speech-to-speech, TTS, and ASR in one model

| Field | Value |
|-------|-------|
| Task | Speech-to-Speech |
| Languages | -- |
| Repo | [mlx-community/LFM2.5-Audio-1.5B-4bit](https://huggingface.co/mlx-community/LFM2.5-Audio-1.5B-4bit) |
| Source Docs | [Source Docs](https://github.com/Blaizzy/mlx-audio/blob/main/mlx_audio/sts/models/lfm_audio/README.md) |
| Features | multimodal |
