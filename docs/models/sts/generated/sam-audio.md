...
| Languages | -- |
| Repo | [mlx-community/sam-audio-large](https://huggingface.co/mlx-community/sam-audio-large) |
| Source Docs | [Source Docs](https://github.com/Blaizzy/mlx-audio/blob/main/mlx_audio/sts/models/sam_audio/README.md) |
| Features | source separation |
