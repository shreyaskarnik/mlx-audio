...
Multilingual ASR with streaming support
...
| Repo | [mlx-community/Qwen3-ASR-1.7B-8bit](https://huggingface.co/mlx-community/Qwen3-ASR-1.7B-8bit) |
...
| Features | Streaming, Timestamps, streaming |
