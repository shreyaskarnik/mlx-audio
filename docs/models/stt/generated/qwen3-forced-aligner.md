...
Word-level forced alignment for speech transcripts
...
| Repo | [mlx-community/Qwen3-ForcedAligner-0.6B-8bit](https://huggingface.co/mlx-community/Qwen3-ForcedAligner-0.6B-8bit) |
| Source Docs | [Source Docs](https://github.com/Blaizzy/mlx-audio/blob/main/mlx_audio/stt/models/qwen3_asr/README.md) |
| Pipeline Tag | `automatic-speech-recognition` |
| Features | Timestamps, alignment, word timestamps |
