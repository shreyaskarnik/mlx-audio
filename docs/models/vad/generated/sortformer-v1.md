...
End-to-end speaker diarization for up to four speakers

| Field | Value |
|-------|-------|
| Task | Voice Activity Detection |
| Languages | -- |
| Repo | [mlx-community/diar_sortformer_4spk-v1-fp32](https://huggingface.co/mlx-community/diar_sortformer_4spk-v1-fp32) |
