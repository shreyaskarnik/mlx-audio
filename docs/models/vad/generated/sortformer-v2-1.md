...
Streaming speaker diarization with AOSC compression

| Field | Value |
|-------|-------|
| Task | Voice Activity Detection |
| Languages | -- |
| Repo | [mlx-community/diar_streaming_sortformer_4spk-v2.1-fp32](https://huggingface.co/mlx-community/diar_streaming_sortformer_4spk-v2.1-fp32) |
| Source Docs | [Source Docs](https://github.com/Blaizzy/mlx-audio/blob/main/mlx_audio/vad/models/sortformer/README.md) |
| Features | Streaming, Diarization, speaker diarization, streaming |
